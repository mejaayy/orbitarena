...
export const Leaderboard: React.FC<LeaderboardProps> = ({ players, localPlayerId, timeRemaining, isStakeMode }) => {
  ...
  return (
    <Card className="absolute top-[168px] left-[20px] w-28 md:w-36 bg-black/40 backdrop-blur-md border-white/5 p-2 md:p-3 text-white pointer-events-none select-none z-10">
